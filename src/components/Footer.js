    ...
    return (
        <div className="fixed inset-x-0 bottom-6 flex justify-center z-50">
            ...
            >
                ...
                >
                    <div className="w-[44px] h-[44px] sm:w-[54px] sm:h-[54px] rounded-full flex items-center justify-center bg-[linear-gradient(135deg,rgba(120,230,255,1),rgba(95,140,255,1),rgba(160,90,255,1))] shadow-[0_10px_26px_rgba(0,0,0,0.35)]">
                ...
                <div className="flex gap-6 sm:gap-10 pb-4">
                    <button className="flex flex-col items-center gap-2 text-white/90">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-semibold tracking-wide">EVENT</span>
                    </button>

                    <button className="flex flex-col items-center gap-2 text-white/90">
                        <Image src="/icons/task.svg" width={20} height={20} alt="task" />
                        <span className="text-[10px] sm:text-[11px] font-semibold tracking-wide">TASK</span>
                    </button>
                </div>
                ...
                <div className="flex gap-6 sm:gap-10 pb-4">
                    <button className="flex flex-col items-center gap-2 text-white/90">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-semibold tracking-wide">SWAP</span>
                    </button>

                    <button className="flex flex-col items-center gap-2 text-white/90">
                        <Image src="/icons/profile.svg" width={20} height={20} alt="profile" />
                        <span className="text-[10px] sm:text-[11px] font-semibold tracking-wide">PROFILE</span>
                    </button>
                </div>
