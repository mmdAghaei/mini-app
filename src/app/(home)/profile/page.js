    ...
    return (
        <div className="w-full flex justify-center px-4 sm:px-6 mt-10">
            <div
                className="
          relative w-full
          max-w-[clamp(20rem,92vw,28rem)]
          rounded-[clamp(1rem,2.6vw,1.25rem)]
          border border-white/15
          bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(213,255,123,0.14),transparent_55%),linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))]
          backdrop-blur-xl
            ...
            >
                ...
                <div className="relative p-[clamp(1rem,3vw,1.5rem)] flex flex-col items-center">
                    ...
                    <div className="relative">
                        <div
                            className="
                h-[clamp(4rem,10vw,5rem)] w-[clamp(4rem,10vw,5rem)]
                rounded-full
                bg-white/10
                border border-white/15
              ...
              "
                    ...
                    <div className="mt-[clamp(1rem,2.6vw,1.25rem)] w-full flex items-center gap-3">
                        <button
                            className="
                flex-1
                h-[clamp(2.8rem,6.5vw,3.1rem)]
                rounded-[clamp(0.75rem,1.8vw,0.95rem)]
                bg-[linear-gradient(90deg,#d5ff7b,#f6fa00)]
                text-black font-extrabold
                text-[clamp(0.95rem,1.2vw,1.05rem)]
                shadow-[0_18px_40px_rgba(213,255,123,0.18)]
